...
@php
    ...
    // Récupération du paramètre `from_gpo` avec fallback Referer.
    //
    ...
    //
    // Garde défensive : `Request::query` peut retourner un
    ...
    if ($guid !== null) {
        try {
            ...
            // Fallback silencieux — latence ou GPO supprimée
            $displayName = null;
        }
    }
@endphp
...
@elseif ($guid !== null)
    {{-- Fallback générique : guid présent mais GPO introuvable --}}

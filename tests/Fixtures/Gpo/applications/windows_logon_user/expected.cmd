...
SET id=e32b20d400dd5651c7544bffa04bb48d
IF [%SE4FS%]==[] (
    SET SE4FS=se4fs
)
...
curl -o "%TEMP%\applications-logon.ps1" -F "interpreter=powershell" -F "id=e32b20d400dd5651c7544bffa04bb48d"  "http://se4fs/gpo/applications.php">NUL
IF EXIST "%TEMP%\applications-logon.ps1" (
...
curl -F "os=windows" -F "uuid=%UUID%" -F "speed=%SPEED%" -F "id=e32b20d400dd5651c7544bffa04bb48d"  -F "ret=0"  "http://se4fs/gpo/applications.php">NUL

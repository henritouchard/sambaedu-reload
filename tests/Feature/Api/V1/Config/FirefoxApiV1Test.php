...
/**
 * Story 16.13 — AC5.2 (`/api/v1/workstation-config/firefox`).
 *
 * ≥5 tests minimaux : 401 missing/expired/wrong_tier, 404 unknown,
 * 200 happy path JSON.
 */
class FirefoxApiV1Test extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Templates fixtures iso AppPolicyLegacyEndpointTest.
    ...
    {
        $this->getJson('/api/v1/workstation-config/firefox')
            ->assertStatus(401)
    ...
    public function expired_jwt_returns_401_expired(): void
    {
        ...
        $this->getJson('/api/v1/workstation-config/firefox', ['Authorization' => 'Bearer ' . $emitted['token']])
            ->assertStatus(401)
    ...
    public function happy_path_returns_200_json(): void
    {
        ...
        $response = $this->getJson(
            '/api/v1/workstation-config/firefox?os=linux&user=jdoe',
    ...
    public function response_has_no_store_cache_headers(): void
    {
        ...
        $response = $this->getJson(
            '/api/v1/workstation-config/firefox',
            ['Authorization' => 'Bearer ' . $emitted['token']],
        );

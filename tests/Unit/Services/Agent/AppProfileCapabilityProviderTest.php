...
/**
 * Tests Unit du provider `app_profile` : redirection du profil
...
class AppProfileCapabilityProviderTest extends TestCase
{
    ...
    public function server_path_is_a_token_never_resolved_server_side(): void
    {
        ...
        // Chemin serveur = TOKEN home + relatif du catalogue.
        self::assertSame(
    ...
    {
        // DÉCORRÉLATION du gate K: : le lien pointe l'UNC
    ...
    {
        // Défaut d'instance = default_value `on` : un
    ...
    {
        // « off réel » par entrée : `enabled:false` n'émet plus.
    ...
    {
        // Basculer default_value à `off` inverse la politique
    ...
    {
        // Défaut off, mais un groupe d'utilisateurs assigné `on`
    ...
    {
        // Défaut on, mais le groupe est assigné `off` : couvert
    ...
    {
        // Sémantique OR : couvert par au moins UNE assignation
    ...
    {
        // Précédence specificity : une assignation User (rang 0)

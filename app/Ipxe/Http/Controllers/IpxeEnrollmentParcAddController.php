 ...
 * {@see IpxeEnrollmentOrchestrator::handleParcAdd()}.
 *
 * **Sert** : `GET|POST /ipxe/enrollment/parc-add` (port natif de
 * `sambaedu/ipxe/parcs.php`).
 */
class IpxeEnrollmentParcAddController extends Controller
{
    ...
    {
        return $this->orchestrator->handleParcAdd($request);
    }
}

...
/**
 * Listener Login event : émet un toast warning si l'utilisateur
 * connecté est en dépassement (soft ou hard) d'au moins une partition.
 *
 * Listener sur `Illuminate\Auth\Events\Login` plutôt que
 ...
 * commande `quota:snapshot` à 03h00). Aucun shellout depuis ce listener.
 *

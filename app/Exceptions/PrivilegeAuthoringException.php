...
/**
 * Levée quand une projection `windows/privilege` viole le
 ...
 * portant un droit *grant* (risque de VERROUILLAGE machine) ne peut
...
class PrivilegeAuthoringException extends \RuntimeException
{
    ...
    {
        parent::__construct(
            "Projection privilege refusée par le garde-fou d'authoring :\n- "
            .implode("\n- ", $violations)
        );
    }
}

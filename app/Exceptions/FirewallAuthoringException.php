...
/**
 * Levée quand une projection `windows/firewall` viole le
 ...
 *
 * Rend la règle « block couvrant le LAN/tout interdit » (intersection
 * mathématique) RÉELLE au runtime serveur : une projection dangereuse ne peut
 * plus être enregistrée (protège aussi le futur formulaire). Le message
...
class FirewallAuthoringException extends \RuntimeException
{
    ...
    {
        parent::__construct(
            "Projection firewall refusée par le garde-fou d'authoring :\n- "
            .implode("\n- ", $violations)
        );
    }
}

...
final class ExternalStorageDefinition
{
     ...
     * @return list<self>
     */
    public static function canonicalSet(string $host): array
    {
        return [
            new self('Partages', $host, self::SHARE_PARTAGES),
            new self('Documents', $host, self::SHARE_USERS, self::USER_PLACEHOLDER),
        ];
    }

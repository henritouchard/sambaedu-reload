 ...
 *
 * S'y ajoute la MATÉRIALISATION DE L'ARBRE : créer un groupe dont le
 ...
 * depuis la : chaque canal son flag.
 *
 * **La SUPPRESSION d'un groupe ne déprovisionne rien** : la ligne du partage
...
class UserGroupObserver
{
    ...
    {
        // Ancré AVANT le garde de projection d'annuaire, sous son

...
/**
 * Endpoint de RÉCEPTION du signal de rupture du lien
 * amont (controlHub), authentifié par le middleware `controlhub.auth`.
 *
 * Canal jumeau de la commande artisan `controlhub:sever-link` : les DEUX
 * partagent le service UNIQUE {@see ControlHubContractSeveranceService}. La forme
 * exacte du payload wire relève d' ; ici elle reste MINIMALE (motif

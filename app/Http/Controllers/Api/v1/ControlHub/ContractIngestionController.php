 ...
 * mutation) vit dans {@see ControlHubContractIngestionService::ingest()} — ce
 * contrôleur ne fait AUCUNE validation métier, AUCUNE normalisation,
...
class ContractIngestionController extends Controller
{
    ...
    public function __invoke(
        ...
        // Durcissement de la frontière HTTP. On
        ...
        // imposés + ré-activation SILENCIEUSE d'un lien rompu, le tout en 200.

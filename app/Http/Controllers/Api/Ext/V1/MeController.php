 ...
 *
 *  ⚠️ CONTRAT PUBLIC v1 — GELÉ À LA LIVRAISON
 *
 *  Ce que rend ce contrôleur sera consommé par du code que nous n'écrivons pas
 * (l'extension BBB, le SDK) et que nous ne redéployons pas. Règle asymétrique,
 *  identique à celle des claims :
 *
 ...
 *
 * **Les valeurs sont celles du contrat de claims, VERBATIM.** Elles
 ...
 * l'utilisateur : une extension n'accède ni à la base ni à l'annuaire, et cette
 * garantie tient précisément parce que la surface exposée est exactement
 ...
 * CONSTRUCTION, jamais par une re-résolution qui pourrait diverger (cf. « Les
 * invariants à ne pas casser » dans `app/Auth/Oidc/README.md`).
 *
 ...
 * de requête (doctrine `AuthenticateAgentToken`). Un paramètre
...
class MeController extends Controller
{
     ...
     * hors vocabulaire) : c'est le contrat gelé — jamais `null`, jamais

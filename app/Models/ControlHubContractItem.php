...
/**
 * Item imposé d'un contrat amont (controlHub).
 *
 ...
 * @property string $target_label Nom du label ciblé si target_type=label ; '' = cible instance (NOT NULL)
 * @property string|null $delivery_mode — mode de livraison amont (capturé, non arbitré)
 * @property string|null $artifact_checksum — sha256 hex = identité stable du binaire imposé
 * @property string|null $artifact_filename — nom informatif (jamais utilisé pour le nommage disque)
 * @property int|null $artifact_size — taille attendue du binaire en octets
 * @property \App\Enums\ControlHubArtifactPullStatus|null $pull_status — état du pull (pending|downloaded|error)
 * @property string|null $pull_error — message court d'échec du pull
...
class ControlHubContractItem extends Model
{
    ...
    protected $fillable = [
        ...
        'target_type',
        'target_label',
        // Canal ④ (additifs nullables ; artifact_url N'EST PAS une colonne).
        'delivery_mode',
        'artifact_checksum',
        'artifact_filename',
        'artifact_size',

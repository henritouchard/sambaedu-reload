...
/**
 * Snapshot quotidien des tailles de profils itinérants.
 *
 ...
 *
 * Calque le pattern `quota:snapshot` : un job nocturne calcule UNE
 * FOIS et écrit le cache ; l'UI lit le cache sans aucun shellout/scan par render.
 * CONTRAINTE PERF non négociable : `du`/scan FS = ce job UNIQUEMENT.
 *

...
|--------------------------------------------------------------------------
|
| Traduction française des messages de validation Laravel. Le tableau
| « attributes » remappe les noms techniques des champs (nom, prenom, …)
| vers un libellé lisible utilisé dans les messages.
|
*/
...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Remappe les noms techniques des champs vers des libellés lisibles

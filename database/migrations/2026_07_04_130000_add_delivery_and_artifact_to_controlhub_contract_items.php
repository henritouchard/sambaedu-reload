...
/**
 * Canal ④ : ingestion + pull des binaires imposés par le contrat amont
 ...
 * est INCHANGÉE (idempotence préservée).
 *
 * ⚠️ `artifact_url` n'est VOLONTAIREMENT PAS une colonne (piège d'idempotence) : les URL
 ...
 *
 * - `delivery_mode` (string nullable) — mode de livraison amont (capturé, non arbitré) ;

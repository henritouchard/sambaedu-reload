...
/**
 * Colonne d'arête `is_head_teacher` (convergence vers le modèle
 * « 1 ligne = 1 classe »).
 *
 ...
 * rétro-remplissage d'une base peuplée AVANT reste un geste manuel via
 ...
 *
 * Note exécution : les migrations VM ne sont PAS auto-jouées par le
...
return new class extends Migration {
    public function up(): void
    {
        ...
        // peuplée avant reste un geste manuel via l'action invocable.
    }

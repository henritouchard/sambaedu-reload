...
/**
 * Capacité de GATING du mécanisme HORS-REGISTRE
 ...
 * jamais du code servi en HTTP).
 *
 * Pattern iso (`2026_07_04_140000_seed_capability_rdp_denied_for_group`) :
 ...
 *
 * **Toggle à deux valeurs — pas de `off`.**
 ...
 *     idempotente du catalogue d'artefacts versionné DANS l'agent.
 *
 ...
 *
 * **VALEUR DE MAP `vanilla`**
 * `{"on": "vanilla"}` encode dans la donnée : suppression des
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // sentinelle (rien émis, agent inactif), `on` = "vanilla".
        // PAS de clé `off` — nettoyage one-way, cf. le bloc en tête de fichier.

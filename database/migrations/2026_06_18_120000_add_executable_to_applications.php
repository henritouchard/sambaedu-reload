...
/**
 * Composer d'associations par défaut (extension libre + app par nom).
 *
 * Ajoute `applications.executable` : le chemin (ou le nom) de l'EXÉCUTABLE RUNTIME
 * de l'application WPKG. C'est la SEULE donnée neuve :
 ...
 *
 * Le CHEMIN RUNTIME COMPLET n'est NI transmis au payload (invariant — le payload
 ...
 * AVANT d'imposer UserChoice. Le BASENAME suffit donc au serveur ; le poste
 ...
 * l'extension visée est REFUSÉE à la composition (garde-fou UI) — pas

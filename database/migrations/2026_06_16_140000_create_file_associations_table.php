 ...
 * (premier type `associations`, table DÉDIÉE, JAMAIS
 ...
 * catalogue ne fuite JAMAIS au payload (invariant central).
 *
 ...
 *
 * **Extension WPKG-aware.** Chaque entrée porte une
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('file_associations', function (Blueprint $table) {
            ...
            // Source du ProgId : SERVEUR-only, jamais émis au payload.

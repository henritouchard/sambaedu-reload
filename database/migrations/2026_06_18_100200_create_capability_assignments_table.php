...
/**
 * Override de VALEUR d'une capacité par maille (remplace
 * `registry_setting_assignables`). Calqué sur le pivot polymorphe :
 ...
 *
 * Différence clé avec : l'override remonte au niveau de la CAPACITÉ (« ce

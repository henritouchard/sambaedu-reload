 ...
 * : table Eloquent interrogeable, écriture best-effort, pas un
 * fichier de log à parser.
 *
 * RAISON D'ÊTRE de la dénormalisation : la anonymise
 ...
 * tables existantes. FK nullable best-effort `set null` (pattern — sqlite
...
return new class extends Migration {
    public function up(): void
    {
        ...
        Schema::create('external_action_audit_logs', function (Blueprint $table): void {
            ...
            // Nom du rôle Spatie ACTIF résolu par (ex. `technicien`).
            $table->string('actor_role')->nullable()->comment('Nom du rôle Spatie actif, copié');

            // Discrimine l'origine externe vs AD locale. En dur
        ...
        // FK best-effort (pattern) : sur certaines plateformes

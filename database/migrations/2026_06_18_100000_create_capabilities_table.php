...
/**
 * Repensée « registre » en gestion de CAPACITÉS/options données aux
 * postes (« capability-first »).
 *
 ...
 *
 * Invariant central conservé : le `key`/`id` de la capacité ne fuite
...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('capabilities', function (Blueprint $table) {
            ...
            // Défaut DIFFUSÉ (Broadcast) : valeur effective de la capacité
            ...
            // gelé = plus de NOUVEAUX overrides (la diffusion du défaut
